...
class Game:
    def __init__(self):
        ...
        self.state = 'start'
        self.images = {'background': './assets/background.png', 'start_page': 'assets/start_screen.png',
                       'spaceship': 'assets/spaceship.png', 'asteroid': 'assets/asteroid.png',
                       'missile': 'assets/missile.png', 'moving_spaceship': 'assets/spaceship_moving.png'}
    ...
    def actual_game(self):
        self.spaceship = Spaceship(self.canvas, WIDTH // 2, HEIGHT // 2, 0, 4.5, (150, 150), self,
